...
public class VoiceRecordingService {
    ...
    @Transactional
    public VoiceRecording saveRecording(Long userId, Long presentationId, MultipartFile file) throws IOException {
        // 1. 파일 이름 생성 및 임시 저장
        ...
        VoiceRecording recording = VoiceRecording.builder()
                .presentationId(presentationId) // 👈 scriptId 대신 presentationId 매핑
                .userId(userId)
                .audioFileUrl(s3Url)
